  ...
  return (
    <div>
      <div className="absolute inset-0 w-full h-full bg-black overflow-hidden mt-[8rem]">
        ...
        <div className="absolute top-[15%] bottom-0 w-px bg-white left-[34%]" />{" "}
        {/* left of core features */}
        <div className="absolute top-[15%] bottom-0 w-px bg-white/50 left-[37.5%]" />{" "}
        {/* right of top left gray square */}
        ...
        <div className="absolute top-0 bottom-0 w-px bg-white left-[67.45%]" />{" "}
        {/* right of core features */}
        ...
        <div className="absolute left-0 right-0 h-px bg-white top-[15%]" />{" "}
        {/* under core features */}
        <div className="absolute left-0 right-0 h-px bg-white top-[22.5%]" />{" "}
        {/* above top left gray square */}
        <div className="absolute left-0 right-0 h-px bg-white/50 top-[38%]" />{" "}
        {/* below top right square */}
